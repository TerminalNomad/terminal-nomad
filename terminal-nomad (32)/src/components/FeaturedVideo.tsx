      ...
      <div classname="flex flex-col gap-3">
        ...
        >
          {!isPlaying ? (
            ...
            <>
              <img src="{`https://img.youtube.com/vi/${videoId}/maxresdefault.jpg`}" alt="Video Thumbnail" classname="absolute inset-0 w-full h-full object-cover opacity-80 group-hover:opacity-100 transition-opacity duration-500"/>
            ...
            <iframe src="{`https://www.youtube.com/embed/${videoId}?autoplay=1&amp;rel=0&amp;modestbranding=1&amp;playsinline=1`}" title="Featured Drop" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen="" classname="absolute inset-0 w-full h-full"/>
          )}
        </div>
