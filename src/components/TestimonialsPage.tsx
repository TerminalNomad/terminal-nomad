  ...
  <div className="w-full max-w-5xl mx-auto px-5 py-8 animate-fade-in-up">
    ...
    <div className="text-center mb-14">
      ...
      <p className="text-slate-400 text-lg max-w-xl mx-auto">
        Stories from the sky — from those who've taken the leap.
      </p>
    </div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      {TESTIMONIALS.map((review) => (
        <div
          key={review.id}
          className="card p-7 hover:border-brand-accent/30 transition-colors group relative overflow-hidden flex flex-col"
        >
          {/* BG decoration */}
          ...
          <p className="text-slate-300 text-base leading-relaxed mb-6 relative z-10 italic flex-1">
            "{review.text}"
          </p>
    ...
    <div className="mt-16 text-center">
      ...
      <a
        ...
        className="inline-flex items-center gap-2 text-brand-accent hover:text-white transition-colors font-mono uppercase tracking-wider text-sm border-b border-brand-accent/30 hover:border-brand-accent pb-1"
      >
        Submit your review →
      </a>
    </div>
