  ...
  return React.createElement('div', { className: "w-full max-w-4xl mx-auto px-6 py-8 animate-fade-in-up" },
    ...
    React.createElement('div', { className: "text-center mb-16" },
      React.createElement('div', { className: "inline-flex items-center justify-center w-16 h-16 rounded-full bg-brand-accent/10 text-brand-accent mb-6 border border-brand-accent/20" },
        React.createElement(Briefcase, { size: 32 })
      ),
    ...
    React.createElement('div', { className: "grid grid-cols-1 md:grid-cols-2 gap-6 mb-12" },
      ...
      /* Card 1: Tandems */
      React.createElement('div', { className: "bg-slate-900 border border-white/10 p-8 rounded-2xl group hover:border-brand-accent/50 transition-all hover:-translate-y-1" },
        React.createElement('div', { className: "w-12 h-12 bg-blue-500/20 text-blue-400 rounded-lg flex items-center justify-center mb-6 group-hover:bg-blue-500 group-hover:text-white transition-colors" },
          React.createElement(Wind, { size: 24 })
        ),
        React.createElement('h3', { className: "text-xl font-bold text-white font-mono mb-3" }, "Tandem Experiences"),
      ...
      /* Card 2: Brand Deals */
      React.createElement('div', { className: "bg-slate-900 border border-white/10 p-8 rounded-2xl group hover:border-brand-accent/50 transition-all hover:-translate-y-1" },
        React.createElement('div', { className: "w-12 h-12 bg-purple-500/20 text-purple-400 rounded-lg flex items-center justify-center mb-6 group-hover:bg-purple-500 group-hover:text-white transition-colors" },
          React.createElement(Camera, { size: 24 })
        ),
        React.createElement('h3', { className: "text-xl font-bold text-white font-mono mb-3" }, "Brand Partnerships"),
        React.createElement('p', { className: "text-slate-400 leading-relaxed mb-6" },
