  ...
  <div className="w-full max-w-4xl mx-auto px-5 py-8 animate-fade-in-up">
    ...
    <div className="text-center mb-14">
      ...
      <p className="text-slate-400 text-lg max-w-xl mx-auto">
        Partner with NomadicZack for high-altitude experiences and content that converts.
      </p>
    </div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
      ...
      <div className="card p-8 group hover:border-brand-accent/40 transition-all hover:-translate-y-1">
        ...
        <p className="text-slate-400 leading-relaxed mb-6 text-sm">
          Jump with me personally. I offer exclusive VIP tandem experiences with premium 4K video and photos. I handle the safety, you handle the screaming.
        </p>
        <a
          href="mailto:zack@terminalnomad.com?subject=Tandem Inquiry"
          className="inline-flex items-center gap-2 text-brand-accent font-mono text-sm uppercase tracking-wider hover:text-white transition-colors"
        >
          Book a Jump
      ...
      <div className="card p-8 group hover:border-brand-accent/40 transition-all hover:-translate-y-1">
        ...
        <a
          href="mailto:zack@terminalnomad.com?subject=Brand Partnership"
          className="inline-flex items-center gap-2 text-brand-accent font-mono text-sm uppercase tracking-wider hover:text-white transition-colors"
        >
          Start a Campaign
          <ArrowUpRight size={15} aria-hidden="true" />
    ...
    {/* General CTA */}
    <div
      className="card border-brand-accent/30 p-8 text-center"
    ...
    >
      ...
      <p className="text-slate-300 mb-7">
        If it involves altitude, adrenaline, or adventure — I'm listening.
      </p>
      <a
        href="mailto:zack@terminalnomad.com"
        className="inline-flex items-center gap-2 px-8 py-3.5 rounded-full bg-brand-accent hover:bg-white text-brand-dark font-bold font-mono text-sm uppercase tracking-widest transition-all hover:scale-105 active:scale-95 shadow-lg shadow-brand-accent/20"
      >
        Contact Me
      </a>
    </div>
