    ...
    <div className="w-full max-w-2xl mx-auto px-5 py-8 animate-fade-in-up">
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-slate-400 text-base max-w-md mx-auto leading-relaxed">
          Behind-the-scenes footage, gear reviews, and travel updates delivered to your inbox.
          No spam, just altitude.
        </p>
      </div>
      ...
      <div
        id="mlb2-34198267"
        className="card p-8 md:p-12 relative overflow-hidden ml-subscribe-form ml-subscribe-form-34198267"
      >
        <div className="ml-form-embedWrapper embedForm">
          ...
          <div className="ml-form-embedBody ml-form-embedBodyDefault row-form">
            <form
              className="ml-block-form space-y-5"
            ...
            >
              <div className="ml-form-formContent">
                <div className="ml-form-fieldRow">
                  <div className="ml-field-group ml-field-email ml-validate-email ml-validate-required">
                    <label
                      htmlFor="ml-email"
                      className="block text-slate-400 text-xs font-mono uppercase tracking-wider mb-2"
                    >
                      Comms Channel (Email)
                    </label>
                    <input
                      ...
                      aria-required="true"
                      type="email"
                      className="w-full bg-black/40 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-slate-600 focus:outline-none focus:border-brand-accent focus:ring-1 focus:ring-brand-accent transition-colors text-sm"
                      name="fields[email]"
              ...
              <div className="ml-form-embedSubmit">
                <button
                  type="submit"
                  className="primary w-full flex items-center justify-center gap-2 bg-brand-accent hover:bg-white text-brand-dark font-bold py-4 rounded-xl font-mono uppercase tracking-widest transition-all hover:scale-[1.02] active:scale-95 shadow-lg shadow-brand-accent/20 text-sm"
                >
                ...
                <button
                  ...
                  type="button"
                  style={{ display: 'none' }}
                  className="loading w-full flex items-center justify-center gap-2 bg-brand-accent/50 text-brand-dark font-bold py-4 rounded-xl font-mono uppercase tracking-widest cursor-wait text-sm"
                >
            ...
            <p className="text-xs text-center text-slate-600 mt-5">
              By subscribing you agree to receive emails. Unsubscribe at any time.
            </p>
          </div>
          ...
          <div className="ml-form-successBody row-success" style={{ display: 'none' }}>
            <div className="ml-form-successContent flex flex-col items-center text-center animate-fade-in-up py-8">
              ...
              <button
                onClick={onBack}
                className="px-6 py-2.5 rounded-full glass hover:bg-white/10 text-slate-300 hover:text-white transition-colors font-mono text-sm uppercase tracking-wider"
              >
                Return to Home
              </button>
            </div>
