...
export const HandcamPage = ({ onBack }: HandcamPageProps) => (
  <div className="w-full max-w-4xl mx-auto px-5 py-8 animate-fade-in-up">
    ...
    <div className="text-center mb-12">
      <div
        className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-brand-accent/10 text-brand-accent mb-6 border border-brand-accent/20 shadow-xl"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
          ...
          <div className="space-y-6">
            <div className="flex items-start gap-4">
              <div className="mt-1 bg-brand-accent/15 p-2.5 rounded-xl text-brand-accent flex-shrink-0">
                <Video size={20} aria-hidden="true" />
              </div>
              <div>
                <h3 className="text-white font-bold text-lg mb-1.5">High-Definition Footage</h3>
                <p className="text-slate-400 text-sm leading-relaxed">
                  Crystal-clear 4K or 1080p video of your entire experience, from the plane exit to the landing.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-slate-400 text-sm leading-relaxed">
                  All raw files delivered via email or a secure download link shortly after your landing.
                </p>
              </div>
            </div>
          ...
          <div className="glass rounded-2xl p-7 flex flex-col items-center text-center">
            ...
            <div className="w-full mb-6 p-4 bg-brand-accent/5 border border-brand-accent/20 rounded-xl text-left">
              <p className="text-brand-accent text-xs font-mono uppercase tracking-wider mb-1.5 font-bold">
                Important Note:
              </p>
              <p className="text-slate-300 text-sm leading-relaxed">
                Please enter the{' '}
                <span className="text-white font-bold underline decoration-brand-accent/50">
                  correct passenger's name and email address
                </span>{' '}
                so I can match the footage to your jump.
              </p>
            </div>
            ...
            <a
              ...
              className="w-full flex items-center justify-center gap-3 px-8 py-4 rounded-xl bg-brand-accent hover:bg-white text-brand-dark font-bold font-mono uppercase tracking-widest transition-all hover:scale-105 active:scale-95 shadow-xl shadow-brand-accent/20 text-sm"
            >
              Get My Video
            ...
            <p className="mt-5 text-slate-600 text-xs">
              Opens a secure Square payment page in a new tab.
            </p>
          </div>
        </div>
      </div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
      {[
        {
          icon: Clock,
          title: 'When will I get it?',
          body: 'Usually the same day but may take up to 24 hours.',
        },
        {
          icon: Package,
          title: "What's included?",
          body: 'You receive all raw files from the jump — no compression, no watermarks.',
        },
        {
          icon: HelpCircle,
          title: 'Need help?',
          body: 'Contact me directly at zack@terminalnomad.com for any questions.',
        },
