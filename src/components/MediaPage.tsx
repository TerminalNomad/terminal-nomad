      ...
      <div className="max-w-5xl mx-auto px-4 pt-8 pb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
          ...
          <div className="bg-brand-card border border-brand-accent/30 rounded-2xl p-5">
            ...
            <p className="text-slate-400 text-sm leading-relaxed">
              Pick the package that's right for you and pay securely through Square. Your media is delivered straight to your inbox - see the options just below.
            </p>
          </div>
        </div>
        ...
        <div className="text-center mb-6">
          <h2 className="text-2xl md:text-3xl font-black font-mono mb-2">
            CHOOSE YOUR <span className="text-brand-accent">PACKAGE</span>
          </h2>
          <p className="text-slate-400 text-sm max-w-lg mx-auto">
            Secure Square checkout. Standard media delivered to your inbox within hours.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-6 items-stretch">
          ...
          {/* $50 - Full package */}
          <div className="bg-brand-card border border-brand-accent/25 rounded-2xl p-6 flex flex-col gap-4">
            <div className="flex items-center gap-2">
              <Package size={18} className="text-brand-accent" />
              <h3 className="font-mono font-bold text-sm uppercase tracking-wider">Full Video &amp; Photos</h3>
            </div>
            <span className="text-4xl font-black font-mono">$50</span>
            <ul className="text-slate-300 text-sm leading-relaxed space-y-2 flex-1">
              <li className="flex items-start gap-2"><Check size={15} className="text-brand-accent shrink-0 mt-0.5" /> Full edited video</li>
              <li className="flex items-start gap-2"><Check size={15} className="text-brand-accent shrink-0 mt-0.5" /> All your photos</li>
              <li className="flex items-start gap-2"><Check size={15} className="text-brand-accent shrink-0 mt-0.5" /> Raw video files included</li>
            </ul>
            <a
              href={CHECKOUT_FULL}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-2 px-4 py-3 rounded-lg bg-brand-accent hover:bg-white text-brand-dark font-mono text-xs font-bold uppercase tracking-wider transition mt-auto"
            >
              <ShoppingCart size={14} /> Buy - $50 <ExternalLink size={12} />
            </a>
          </div>

          {/* $35 - 360 upgrade */}
          <div className="bg-brand-card border border-blue-400/30 rounded-2xl p-6 flex flex-col gap-4">
            <div className="flex items-center gap-2">
              <Globe size={18} className="text-blue-400" />
              <h3 className="font-mono font-bold text-sm uppercase tracking-wider">360 Camera Upgrade</h3>
            </div>
            <span className="text-4xl font-black font-mono">$35</span>
            <ul className="text-slate-300 text-sm leading-relaxed space-y-2 flex-1">
              <li className="flex items-start gap-2"><Check size={15} className="text-blue-400 shrink-0 mt-0.5" /> Edited 360 camera video</li>
              <li className="flex items-start gap-2"><Check size={15} className="text-blue-400 shrink-0 mt-0.5" /> Raw Insta360 files included</li>
              <li className="flex items-start gap-2"><Check size={15} className="text-blue-400 shrink-0 mt-0.5" /> Edit it yourself in the free Insta360 app</li>
            </ul>
            <a
              href={CHECKOUT_360}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-2 px-4 py-3 rounded-lg bg-blue-500 hover:bg-white text-white hover:text-brand-dark font-mono text-xs font-bold uppercase tracking-wider transition mt-auto"
            >
              <ShoppingCart size={14} /> Buy - $35 <ExternalLink size={12} />
            </a>
          </div>

          {/* $80 - Combo */}
          <div className="bg-brand-card border border-brand-accent/40 rounded-2xl p-6 flex flex-col gap-4 relative overflow-hidden">
            ...
            <div className="flex items-center gap-2">
              ...
              <h3 className="font-mono font-bold text-sm uppercase tracking-wider">Everything Combo</h3>
            </div>
            <div className="flex items-baseline gap-2">
              <span className="text-4xl font-black font-mono">$80</span>
              <span className="text-slate-500 text-sm font-mono line-through">$85</span>
            </div>
            <ul className="text-slate-300 text-sm leading-relaxed space-y-2 flex-1">
              <li className="flex items-start gap-2"><Check size={15} className="text-brand-accent shrink-0 mt-0.5" /> Full edited video, photos &amp; raw files</li>
              <li className="flex items-start gap-2"><Check size={15} className="text-brand-accent shrink-0 mt-0.5" /> Edited 360 video + raw Insta360 files</li>
              <li className="flex items-start gap-2"><Check size={15} className="text-brand-accent shrink-0 mt-0.5" /> The complete package, best price</li>
            </ul>
            <a
              href={CHECKOUT_COMBO}
              target="_blank"
              ...
              className="inline-flex items-center justify-center gap-2 px-4 py-3 rounded-lg bg-brand-accent hover:bg-white text-brand-dark font-mono text-xs font-bold uppercase tracking-wider transition mt-auto"
            >
              <ShoppingCart size={14} /> Buy - $80 <ExternalLink size={12} />
            </a>
          </div>
        ...
        {/* 360 turnaround note */}
        <div className="flex items-start gap-3 rounded-2xl border border-blue-400/25 bg-blue-500/5 p-5 mb-8">
